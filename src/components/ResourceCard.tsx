...
const ResourceCard = ({ name, link, image }: TResource) => {
  return (
    <a
      ...
      className="md:w-full"
    >
      <div className="md:wfu space-y-[0.937rem] rounded-lg px-[1.875rem] py-2.5 hover:shadow-md md:flex md:flex-row-reverse md:items-center md:justify-between md:py-5">
